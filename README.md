...
To get access to the build artifact, click on any run of the QA workflow that has the `Windows tests for adwatchd` job, and look for the `adwatchd_setup` file.
